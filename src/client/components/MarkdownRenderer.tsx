  ...
  return (
    <div className="text-sm leading-relaxed text-slate-700 dark:text-slate-300">
      <Markdown
        ...
        components={{
          h1: (props) => <h1 className="mt-6 mb-3 text-2xl font-bold text-slate-900 dark:text-slate-100" {...props} />,
          h2: (props) => (
            <h2
              className="mt-6 mb-2 border-b border-slate-200 dark:border-slate-800 pb-1 text-xl font-bold text-slate-900 dark:text-slate-100"
              {...props}
            />
          ),
          h3: (props) => <h3 className="mt-5 mb-2 text-base font-bold text-slate-900 dark:text-slate-100" {...props} />,
          ...
          blockquote: (props) => (
            <blockquote
              className="my-3 border-l-4 border-slate-200 dark:border-slate-800 pl-4 text-slate-500 dark:text-slate-400 italic"
              {...props}
            />
          ),
          code: (props) => {
          ...
          th: (props) => (
            <th className="border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 px-3 py-1.5 font-semibold" {...props} />
          ),
          td: (props) => <td className="border border-slate-200 dark:border-slate-800 px-3 py-1.5" {...props} />,
